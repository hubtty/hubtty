    ...
    def getCommands(self):
        ...
        return [
            ...
            (keymap.TOGGLE_HIDDEN,
             "Toggle the hidden flag for the currently selected pull request"),
            (keymap.TOGGLE_LIST_REVIEWED,
             "Toggle whether only unreviewed or all pull requests are displayed"),
            (keymap.TOGGLE_REVIEWED,
             "Toggle the reviewed flag for the currently selected pull request"),
            (keymap.TOGGLE_STARRED,
             "Toggle the starred flag for the currently selected pull request"),
            (keymap.TOGGLE_MARK,
             "Toggle the process mark for the currently selected pull request"),
            ...
            (keymap.LOCAL_CHERRY_PICK,
             "Cherry-pick the most recent commit of the selected pull request onto the local repo"),
