...
from ghubtty.view import side_diff as view_side_diff
from ghubtty.view import unified_diff as view_unified_diff
from ghubtty.view import mouse_scroll_decorator
import ghubtty.view
...
class ChangeView(urwid.WidgetWrap):
    ...
    def __init__(self, app, change_key):
        ...
        self.log = logging.getLogger('ghubtty.view.change')
        self.app = app
        self.change_key = change_key
        self.revision_rows = {}
        self.message_rows = {}
    ...
    def checkGitRepo(self):
        ...
        if missing_revisions:
            if self.app.sync.offline:
                raise ghubtty.view.DisplayError("Git commits not present in local repository")
