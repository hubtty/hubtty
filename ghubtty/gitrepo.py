...
class CommitContext(object):
    ...
    def decorateMessage(self, commit):
        """Put the Github commit metadata at the front of the message.
        ...
        # Then this function, which reproduces github behaviour, will need
...
class DiffFile(object):
    log = logging.getLogger('ghubtty.gitrepo')
...
class Repo(object):
    def __init__(self, url, path):
        self.log = logging.getLogger('ghubtty.gitrepo')
        self.url = url
        self.path = path
